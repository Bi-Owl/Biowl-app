<template>
  <div
    ...
    :class="[
      ...
      {
        'bg-emerald-100 border-emerald-500 shadow-md': isSelected && !isPending,
        'bg-white border-gray-200': !isSelected && !isPending,
        'cursor-pointer hover:bg-emerald-50 hover:border-emerald-300': !isReadonly && !isPending,
        'cursor-not-allowed': isReadonly || isPending,
